...
CONNECTION_ERROR_CODES: frozenset[int] = frozenset({
    1042, 1043, 1044, 1045,  # Host/handshake/access errors
    2002, 2003, 2005, 2006, 2013, 2026, 2055,  # Connection errors
})

TRANSACTION_ERROR_CODES: frozenset[int] = frozenset({
    1205, 1213, 1223, 1689, 1792, 3101,  # Lock/transaction errors
})

SCHEMA_ERROR_CODES: frozenset[int] = frozenset({
    1007, 1008, 1049, 1050, 1051, 1054,  # DB/table/column errors
    1060, 1061, 1064, 1146, 1215,  # DDL errors
})

ACCESS_DENIED_CODES: frozenset[int] = frozenset({
    1044, 1045, 1142, 1143, 1227, 1370, 1698,  # Permission errors
})

QUERY_ERROR_CODES: frozenset[int] = frozenset({
    1048, 1062, 1064, 1136, 1216, 1217,  # Data/constraint errors
    1242, 1292, 1364, 1366, 1452, 1453,  # Value errors
})
...
_ERROR_BRIEFS: dict[int, str] = {
    # Connection
    1045: "Access denied", 2002: "Cannot connect", 2003: "Cannot connect",
    2006: "Connection lost", 2013: "Connection lost during query",
    # Transaction
    1205: "Lock wait timeout", 1213: "Deadlock detected",
    # Schema
    1049: "Unknown database", 1050: "Table already exists",
    1051: "Unknown table", 1054: "Unknown column", 1064: "SQL syntax error",
    1146: "Table doesn't exist",
    # Query
    1048: "Column cannot be null", 1062: "Duplicate entry",
}
