...
_ANSI_THEME_NAME = "ansi"
_ANSI_THEME = ANSISyntaxTheme(
    {
...
def _resolve_code_theme(theme: str) -> str | SyntaxTheme:
    if theme.lower() == _ANSI_THEME_NAME:
        return _ANSI_THEME
    return theme
...
class MarkdownContext:
    ...
    def __init__(
        ...
        inline_code_theme: str | SyntaxTheme = _ANSI_THEME_NAME,
    ) -> None:
...
class Markdown(JupyterMixin):
    ...
    Args:
        ...
        code_theme (str, optional): Pygments theme for code blocks.
    ...
    def __init__(
        self,
        markup: str,
        code_theme: str = _ANSI_THEME_NAME,
